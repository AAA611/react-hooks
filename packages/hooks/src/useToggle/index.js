...
function useToggle(defaultValue, reverseValue) {
    ...
    var _a = tslib_1.__read((0, react_1.useState)(defaultValue), 2), state = _a[0], setState = _a[1];
    var actions = (0, react_1.useMemo)(function () {
        var reverseValueOrigin = (reverseValue === undefined ? !defaultValue : reverseValue);
        var toggle = function () {
            return setState(function (s) { return (s === defaultValue ? reverseValueOrigin : defaultValue); });
        };
